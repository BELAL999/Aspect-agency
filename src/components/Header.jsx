...
const Header = () => {
    ...
    return (
        <header className={clsx('z-40 flex  mt-6 items-center fixed top-0 left-1/2 -translate-x-1/2 transition-all duration-500 min-lg:border border-[#ffffff33] rounded-full px-2 py-1',hasScroll ? "glass-effect w-[700px]" :"max-w-[1000px] w-full")}> 
